...
$text = $("#label-" + this.element.attr("id")).data("text");
$text == null ? (text = "") : (text = $text);
return (
"<span class='ui-text'><span class='ui-value'>" +
this.element.val() +
"</span>" +
text +
"</span><a class='ui-spinner-button ui-spinner-up ui-corner-tr'><span class='ui-icon " +
...
this.element.parent().children(".ui-text").children().text(i),
